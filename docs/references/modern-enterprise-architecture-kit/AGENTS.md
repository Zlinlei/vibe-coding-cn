...
- V2.12 起，审计导出自动化命令属于可执行企业标准，不应退回说明性段落。
...
- V2.17 起，审计导出完整性清单属于可执行企业标准，不应退回说明性段落。
- V2.18 起，审计导出 provenance statement 属于可执行企业标准，不应退回说明性段落。
- V2.19 起，审计导出签名策略属于可执行企业标准，不应退回说明性段落。
- V2.20 起，审计导出签名验签回执属于可执行企业标准，不应退回说明性段落。
- V2.21 起，POA&M 整改计划属于可执行企业标准，不应退回说明性段落。
- V2.22 起，企业架构风险登记属于可执行企业标准，不应退回说明性段落。
